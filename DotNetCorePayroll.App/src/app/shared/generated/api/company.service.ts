...
export class CompanyService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiCompanyGetCompaniesPost(searchFilter?: SearchFilter, observe?: 'body', reportProgress?: boolean): Observable<ResultCompanyModel>;
    public apiCompanyGetCompaniesPost(searchFilter?: SearchFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResultCompanyModel>>;
    public apiCompanyGetCompaniesPost(searchFilter?: SearchFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResultCompanyModel>>;
    public apiCompanyGetCompaniesPost(searchFilter?: SearchFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
