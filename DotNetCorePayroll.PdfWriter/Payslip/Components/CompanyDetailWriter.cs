...
{
    public class CompanyDetailWriter
    {
        private static CompanyDetailWriter _instance;

        private CompanyDetailWriter()
        {
        }

        public static CompanyDetailWriter Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new CompanyDetailWriter();
                }
